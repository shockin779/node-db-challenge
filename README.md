...
- [x] Explain the difference between `Relational Databases` and `SQL`.
 ...
 Relational Databases are databases that are designed to have tables relate to each other in different ways: ie: one to one, one to many, many to many. SQL is a query language used to query the information in the database

- [x] Why do tables need a `primary key`?

  Primary keys allow you to target a specific record in the database. Without it, it is impossible to guarantee that you can pinpoint an exact record.
...
- [x] What do we need in order to have a _many to many_ relationship between two tables.
  ...
  We need to have a common join table.
